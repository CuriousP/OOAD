...
namespace ElectionCampaignManager.Controllers
{
    public class DonorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Donor_Tin,Large_Donor")] Donor donor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Donor_Tin,Large_Donor")] Donor donor)
        {
            if (ModelState.IsValid)
            {
